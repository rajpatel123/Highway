...
public final class RuntimePermissionHelper {
    ...
    public static final String PERMISSION_ACCESS_CAMERA = Manifest.permission.CAMERA;
    ...
    private void initPermissions() {
        ...
        requiredPermissions.add(PERMISSION_ACCESS_CAMERA);
        requiredPermissions.add(PERMISSION_ACCESS_WRITE_EXTERNAL_STORAGE);
    ...
    private void askPermissions() {
        if(ungrantedPermissions.size()>0) {
            ActivityCompat.requestPermissions(activity, ungrantedPermissions.
                    toArray(new String[ungrantedPermissions.size()]), PERMISSION_REQUEST_CODE);
        }
    }
