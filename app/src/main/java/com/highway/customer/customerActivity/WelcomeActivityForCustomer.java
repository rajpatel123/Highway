...
public class WelcomeActivityForCustomer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!HighwayPrefs.isFirstTimeLaunch(this,Constants.IS_FIRST_TIME_LAUNCH_CUSTOMER)) {
            launchHomeScreen();
            finish();
        }
    ...
    private void launchHomeScreen() {
        ...
        startActivity(new Intent(WelcomeActivityForCustomer.this, DashBoardActivity.class));
        finish();
    }
