...
public class CancleTripAdapterForMillerUser extends RecyclerView.Adapter<CancleTripAdapterForMillerUser.ViewHolder> {
     Context context;
     List<CancelTrip>cancelTrips;
    LatLng sourceAddLatLng;
    LatLng destAddLatLng;

     public CancleTripAdapterForMillerUser(List<CancelTrip>cancelTrips,Context context){
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        sourceAddLatLng = new LatLng(Double.parseDouble(cancelTrip.getSourceLat()),Double.parseDouble(cancelTrip.getSourceLong()));
        destAddLatLng = new LatLng(Double.parseDouble(cancelTrip.getDestinationLat()),Double.parseDouble(cancelTrip.getDestinationLong()));
