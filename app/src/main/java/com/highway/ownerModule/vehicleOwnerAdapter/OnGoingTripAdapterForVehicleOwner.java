...
public class OnGoingTripAdapterForVehicleOwner extends RecyclerView.Adapter<OnGoingTripAdapterForVehicleOwner.ViewHolder> {
    Context context;
    List<OngoingTrip>ongoingTrips;

    public OnGoingTripAdapterForVehicleOwner(List<OngoingTrip> ongoingTrips, Context context) {
